...
- Run `./gradlew createBundlerJar` to create the final jar file
- The final jar file can be found in `cheetah-server/build/libs/cheetah-bundler-26.1.2.local-SNAPSHOT.jar`
